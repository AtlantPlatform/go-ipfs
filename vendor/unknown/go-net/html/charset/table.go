...
import (
	...
	"unknown/go-text/encoding/japanese"
	"unknown/go-text/encoding/korean"
	"unknown/go-text/encoding/simplifiedchinese"
	"unknown/go-text/encoding/traditionalchinese"
	"unknown/go-text/encoding/unicode"
)
